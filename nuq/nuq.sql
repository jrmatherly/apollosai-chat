-- Firecrawl NUQ (New Universal Queue) schema initialization
-- Source: https://github.com/firecrawl/firecrawl/blob/main/apps/nuq-postgres/nuq.sql
--
-- Official schema for self-hosted Firecrawl deployments.
-- Includes PostgreSQL tuning for high-throughput queue operations,
-- pg_cron maintenance jobs, and all required tables/indexes.
...
-- Background writer: pre-flush dirty pages to reduce checkpoint burst
...
-- Maintenance cron jobs: queue_scrape
...
-- Maintenance cron jobs: queue_crawl_finished
